<?php require_once './master/header.php'; ?>
 ...
 <div id='landing_header'>
   ...
   <?php require_once './master/navbar.php'; ?>
    ...
    <div class='container'>
       <form class="simple_form form-inline model-selection" action="http://localhost/simplecar/result.php" accept-charset="UTF-8" method="get">
          ...
          <div class="form-group grouped_select required disabled generation_car_model_id">
             <select class="grouped_select required disabled form-control form-control" disabled="disabled" required="required" aria-required="Model" name="generation[car_model_id]" id="generation_car_model_id">
 ...
 <div id='how_it_works'>
    ...
    <div class='row'>
       <div class='col-sm-2 col-sm-offset-2'>
          <img alt="Choose your car icon" class="img-responsive center-block" src="assets/images/works/choose_car_icon.png" />
          <p class='text-center'>
             Choose any car and receive best prices from all dealers, no need to haggle!
          </p>
       </div>
       <div class='col-sm-2 col-sm-offset-1'>
          <img alt="Pick the best price icon" class="img-responsive center-block" src="assets/images/works/pick_the_best_price_icon.png" />
          <p class='text-center'>
             Pick the best price/location. No dealer can email or call you until you accept the best offer!
          </p>
       </div>
       <div class='col-sm-2 col-sm-offset-1'>
          <img alt="Car delivered to your door icon" class="img-responsive center-block" src="assets/images/works/car_delivered_icon.png" />
          <p class='text-center'>
 ...
 <div id='reviews'>
    ...
    <div class='row'>
       <div class='col-sm-4 col-sm-offset-2'>
          <img alt="" class="img-responsive userpic" src="assets/images/person/daniel.jpg" />
          <p class='quote'>
       ...
       <div class='col-sm-4'>
          <img alt="" class="img-responsive userpic" src="assets/images/person/maria.jpg" />
          <p class='quote'>
