                            ...
                            <form class="simple_form user_identity" action="{{route('signup_post')}}" accept-charset="UTF-8" method="post">
                               <div class='form-inputs'>
                                 <div class="form-group email required user_identity_name">
                                   ...
                                   <input class="string name required form-control form-control form-control" autofocus="autofocus" required="required" aria-required="true" type="text" name="name" value="{{ old('name') }}" id="_user_identity_name" />
                                 </div>
                                 <div class="form-group email required user_identity_email">
                                    ...
                                    <input class="string email required form-control form-control form-control" autofocus="autofocus" required="required" aria-required="true" type="email" name="email" value="{{ old('email') }}" id="_user_identity_email" />
                                  </div>
                                 ...
                                 <div class="form-group email required user_identity_email">
                                    ...
                                    <select name="role_id" class="required form-control form-control form-control" required>
                                  ...
                                  <div class="form-group password required user_identity_password">
                                    ...
                                    <input class="password required form-control form-control" aria-required="true" type="password" name="password_confirmation" id="_user_identity_conf_password" />
                                  </div>
                               </div>
