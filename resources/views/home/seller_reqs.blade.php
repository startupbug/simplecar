...
<div class='s_userrequest'>
  <ul class="order-menu">
   ...
   <form class="simple_form form-inline  s_form" action="{{route('send_model_request')}}" accept-charset="UTF-8" method="post">
      <input name="utf8" type="hidden" value="&#x2713;" />
      <div class="form-group select required">
         <select class="required form-control form-control" required="required" name="" id="">
