...
@section('content')
  ...
  <form class="simple_form new_order_form" id="new_order_form" action="{{route('submit_sell_res')}}" accept-charset="UTF-8" method="post">
                 ...
                 <div class="form-group text optional order_form_comment"><label class="text optional control-label" for="order_form_comment">Name: </label>
                   <input type="text" name="sell_name">
                 </div>

                 <div class="form-group text optional order_form_comment"><label class="text optional control-label" for="order_form_comment">Email: </label>
                   <input type="text" name="sell_email">
                 </div>

                 <div class="form-group text optional order_form_comment"><label class="text optional control-label" for="order_form_comment">Contact: </label>
                   <input type="text" name="sell_contact">
                 </div>
