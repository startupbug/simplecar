                              ...
                              <form class="simple_form user_identity" action="#" accept-charset="UTF-8" method="post">
                                 <div class='form-inputs'>
                                   ...
                                   <div class="form-group required col-sm-5 col-sm-offset-1">
                                      ...
                                      <input class="string required form-control form-control form-control" autofocus="autofocus" required="required" aria-required="true" type="text" name="address" id="_user_identity_address" />
                                   </div>
                                   <div class="form-group required  col-sm-5">
                                       ...
                                       <input class="string required form-control form-control form-control" autofocus="autofocus" required="required" aria-required="true" type="text" name="contact" id="_user_identity_contact" />
                                   </div>
                                   <div class="form-group required col-sm-5 col-sm-offset-1">
                                      <label class="required control-label" for="_user_identity_city">
                                        <abbr title="required">*</abbr> City
                                      </label>
                                      <input class="string required form-control form-control form-control" autofocus="autofocus" required="required" aria-required="true" type="text" name="city" id="_user_identity_city" />
                                   </div>
                                   <div class="form-group required  col-sm-5">
                                       <label class="required control-label" for="_user_identity_area">
                                         <abbr title="required">*</abbr> Area
                                       </label>
                                       <input class="string required form-control form-control form-control" autofocus="autofocus" required="required" aria-required="true" type="text" name="contact" id="_user_identity_area" />
                                   </div>
                                 </div>
